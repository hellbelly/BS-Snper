...
BS-SNPer requires a chromosome length file in the same folder as the reference genome file with name suffix '.len'. This file is automatically generated by BS-SNPer if it does not existed.
...
perl filterCG_SNP.pl <snp_result_file> <meth_result_file> >meth.filter.out
